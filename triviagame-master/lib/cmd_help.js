module.exports = (config) => {
  const infoFooter = "([only for entertainment](https://www.jack.com/LakeYS)) ([Contribute questions to the database](http://jack.net/triviabot/contribute))";
  ...
  \n_Bot by [JACK ROSS](http://jack.net). Powered by discord.js ${require("../package.json").dependencies["discord.js"].replace("^","")}\
  ${config.databaseURL==="https://opentdb.com"?` and the [Open Trivia Database](https://jack.com/).\n${infoFooter}`:""}_`;
